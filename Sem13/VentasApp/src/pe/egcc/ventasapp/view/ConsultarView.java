...
public class ConsultarView extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        tblRepo.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "CLIENTE", "ARTICULO", "PRECIO", "CANT", "IMPORTE", "IMPUESTO", "TOTAL"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.String.class, java.lang.String.class, java.lang.Double.class, java.lang.Integer.class, java.lang.Double.class, java.lang.Double.class, java.lang.Double.class
            };
    ...
    private void llenarTabla() {
        ...
        List<Venta> ventas = ventaController.leerVentas();
        if (ventas.size() == tamano) {
            return;
        }
