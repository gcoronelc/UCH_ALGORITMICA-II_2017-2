...
public class RegistrarView extends javax.swing.JInternalFrame {
    ...
    private void llenarCombo(){
        ...
        List<Producto> productos = ventaController.leerProductos();
    ...
    private void initComponents() {
        ...
        txtPrecio.setDisabledTextColor(new java.awt.Color(0, 102, 255));
    ...
    private Venta leerDatos() {
        ...
        venta.setArticulo(cboProducto.getSelectedItem().toString());
